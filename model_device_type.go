...
type DeviceType struct {
	...
	CoolingMethod NullableDeviceCoolingMethod     `json:"cooling_method,omitempty"`
	...
	CoolingIntakeTemplateCount     int32                  `json:"cooling_intake_template_count"`
	CoolingOutflowTemplateCount    int32                  `json:"cooling_outflow_template_count"`
...
func NewDeviceType(id int32, url string, display string, manufacturer BriefManufacturer, model string, slug string, consolePortTemplateCount int32, consoleServerPortTemplateCount int32, powerPortTemplateCount int32, powerOutletTemplateCount int32, coolingIntakeTemplateCount int32, coolingOutflowTemplateCount int32, interfaceTemplateCount int32, frontPortTemplateCount int32, rearPortTemplateCount int32, deviceBayTemplateCount int32, moduleBayTemplateCount int32, inventoryItemTemplateCount int32) *DeviceType {
	...
	this.CoolingIntakeTemplateCount = coolingIntakeTemplateCount
	this.CoolingOutflowTemplateCount = coolingOutflowTemplateCount
...
// SetCoolingMethod gets a reference to the given NullableDeviceCoolingMethod and assigns it to the CoolingMethod field.
...
// GetCoolingIntakeTemplateCount returns the CoolingIntakeTemplateCount field value
...
// GetCoolingIntakeTemplateCountOk returns a tuple with the CoolingIntakeTemplateCount field value
// and a boolean to check if the value has been set.
...
// SetCoolingIntakeTemplateCount sets field value
func (o *DeviceType) SetCoolingIntakeTemplateCount(v int32) {
	o.CoolingIntakeTemplateCount = v
}

// GetCoolingOutflowTemplateCount returns the CoolingOutflowTemplateCount field value
...
// GetCoolingOutflowTemplateCountOk returns a tuple with the CoolingOutflowTemplateCount field value
// and a boolean to check if the value has been set.
...
// SetCoolingOutflowTemplateCount sets field value
