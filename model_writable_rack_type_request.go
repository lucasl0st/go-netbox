...
type WritableRackTypeRequest struct {
	...
	FormFactor   BulkRackTypeRequestFormFactor      `json:"form_factor"`
	...
	CoolingCapability NullableBulkRackRequestCoolingCapability `json:"cooling_capability,omitempty"`
	// Cooling capacity (kW)
...
func (o *WritableRackTypeRequest) GetCoolingCapability() BulkRackRequestCoolingCapability {
	if o == nil || IsNil(o.CoolingCapability.Get()) {
		var ret BulkRackRequestCoolingCapability
		return ret
	}
...
// SetCoolingCapability gets a reference to the given NullableBulkRackRequestCoolingCapability and assigns it to the CoolingCapability field.
