...
func Test_netbox_ExtrasAPIService(t *testing.T) {
	...
	t.Run("Test ExtrasAPIService ExtrasScriptsRun", func(t *testing.T) {

		t.Skip("skip test") // remove to run test

		var id string

		resp, httpRes, err := apiClient.ExtrasAPI.ExtrasScriptsRun(context.Background(), id).Execute()
	...
	t.Run("Test ExtrasAPIService ExtrasScriptsUploadCreate", func(t *testing.T) {

		t.Skip("skip test") // remove to run test

		resp, httpRes, err := apiClient.ExtrasAPI.ExtrasScriptsUploadCreate(context.Background()).Execute()
	...
	t.Run("Test ExtrasAPIService ExtrasScriptsUploadPartialUpdate", func(t *testing.T) {

		t.Skip("skip test") // remove to run test

		var id string

		resp, httpRes, err := apiClient.ExtrasAPI.ExtrasScriptsUploadPartialUpdate(context.Background(), id).Execute()
	...
	t.Run("Test ExtrasAPIService ExtrasScriptsUploadUpdate", func(t *testing.T) {

		t.Skip("skip test") // remove to run test

		var id string

		resp, httpRes, err := apiClient.ExtrasAPI.ExtrasScriptsUploadUpdate(context.Background(), id).Execute()
