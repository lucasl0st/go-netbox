...
type VLANTranslationPolicy struct {
	...
	Rules                []BriefVLANTranslationRule `json:"rules"`
...
func (o *VLANTranslationPolicy) GetRules() []BriefVLANTranslationRule {
	if o == nil {
		var ret []BriefVLANTranslationRule
		return ret
	}
...
func (o *VLANTranslationPolicy) SetCreatedNil() {
	o.Created.Set(nil)
}
...
func (o *VLANTranslationPolicy) SetLastUpdatedNil() {
