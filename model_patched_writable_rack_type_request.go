...
type PatchedWritableRackTypeRequest struct {
	...
	FormFactor   *BulkRackTypeRequestFormFactor      `json:"form_factor,omitempty"`
...
// SetFormFactor gets a reference to the given BulkRackTypeRequestFormFactor and assigns it to the FormFactor field.
