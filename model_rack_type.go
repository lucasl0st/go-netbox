...
type RackType struct {
	...
	FormFactor   RackTypeFormFactor `json:"form_factor"`
	...
	CoolingCapability NullableRackCoolingCapability `json:"cooling_capability,omitempty"`
	// Cooling capacity (kW)
...
// SetCoolingCapability gets a reference to the given NullableRackCoolingCapability and assigns it to the CoolingCapability field.
