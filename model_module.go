...
type Module struct {
	...
	IsBayCompatible      bool                   `json:"is_bay_compatible"`
...
func NewModule(id int32, url string, display string, device BriefDevice, moduleBay NestedModuleBay, moduleType BriefModuleType, isBayCompatible bool) *Module {
	...
	this.IsBayCompatible = isBayCompatible
	return &this
}
...
// GetIsBayCompatible returns the IsBayCompatible field value
...
// GetIsBayCompatibleOk returns a tuple with the IsBayCompatible field value
// and a boolean to check if the value has been set.
...
// SetIsBayCompatible sets field value
