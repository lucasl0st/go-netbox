...
type ModuleBay struct {
	...
	IsModuleCompatible   bool                   `json:"is_module_compatible"`
...
func NewModuleBay(id int32, url string, display string, device BriefDevice, name string, occupied bool, isModuleCompatible bool) *ModuleBay {
	...
	this.IsModuleCompatible = isModuleCompatible
	return &this
}
...
// GetIsModuleCompatible returns the IsModuleCompatible field value
...
// GetIsModuleCompatibleOk returns a tuple with the IsModuleCompatible field value
// and a boolean to check if the value has been set.
...
// SetIsModuleCompatible sets field value
