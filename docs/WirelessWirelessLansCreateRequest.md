...
`func (o *WirelessWirelessLansCreateRequest) GetGroup() BulkWirelessLANRequestGroup`

GetGroup returns the Group field if non-nil, zero value otherwise.

### GetGroupOk

`func (o *WirelessWirelessLansCreateRequest) GetGroupOk() (*BulkWirelessLANRequestGroup, bool)`
...
`func (o *WirelessWirelessLansCreateRequest) SetGroup(v BulkWirelessLANRequestGroup)`
...
`func (o *WirelessWirelessLansCreateRequest) GetVlan() BulkInterfaceRequestUntaggedVlan`

GetVlan returns the Vlan field if non-nil, zero value otherwise.

### GetVlanOk

`func (o *WirelessWirelessLansCreateRequest) GetVlanOk() (*BulkInterfaceRequestUntaggedVlan, bool)`
...
`func (o *WirelessWirelessLansCreateRequest) SetVlan(v BulkInterfaceRequestUntaggedVlan)`
