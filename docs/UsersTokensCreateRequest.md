...
`func (o *UsersTokensCreateRequest) GetVersion() BulkTokenRequestVersion`

GetVersion returns the Version field if non-nil, zero value otherwise.

### GetVersionOk

`func (o *UsersTokensCreateRequest) GetVersionOk() (*BulkTokenRequestVersion, bool)`
...
`func (o *UsersTokensCreateRequest) SetVersion(v BulkTokenRequestVersion)`
