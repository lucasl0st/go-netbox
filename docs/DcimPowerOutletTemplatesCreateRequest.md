...
`func (o *DcimPowerOutletTemplatesCreateRequest) GetDeviceType() BulkConsolePortTemplateRequestDeviceType`

GetDeviceType returns the DeviceType field if non-nil, zero value otherwise.

### GetDeviceTypeOk

`func (o *DcimPowerOutletTemplatesCreateRequest) GetDeviceTypeOk() (*BulkConsolePortTemplateRequestDeviceType, bool)`
...
`func (o *DcimPowerOutletTemplatesCreateRequest) SetDeviceType(v BulkConsolePortTemplateRequestDeviceType)`
...
`func (o *DcimPowerOutletTemplatesCreateRequest) GetModuleType() BulkConsolePortTemplateRequestModuleType`

GetModuleType returns the ModuleType field if non-nil, zero value otherwise.

### GetModuleTypeOk

`func (o *DcimPowerOutletTemplatesCreateRequest) GetModuleTypeOk() (*BulkConsolePortTemplateRequestModuleType, bool)`
...
`func (o *DcimPowerOutletTemplatesCreateRequest) SetModuleType(v BulkConsolePortTemplateRequestModuleType)`
...
`func (o *DcimPowerOutletTemplatesCreateRequest) GetType() BulkPowerOutletRequestType`

GetType returns the Type field if non-nil, zero value otherwise.

### GetTypeOk

`func (o *DcimPowerOutletTemplatesCreateRequest) GetTypeOk() (*BulkPowerOutletRequestType, bool)`
...
`func (o *DcimPowerOutletTemplatesCreateRequest) SetType(v BulkPowerOutletRequestType)`
...
`func (o *DcimPowerOutletTemplatesCreateRequest) GetColor() BriefModuleBayTypeColor`

GetColor returns the Color field if non-nil, zero value otherwise.

### GetColorOk

`func (o *DcimPowerOutletTemplatesCreateRequest) GetColorOk() (*BriefModuleBayTypeColor, bool)`
...
`func (o *DcimPowerOutletTemplatesCreateRequest) SetColor(v BriefModuleBayTypeColor)`
...
`func (o *DcimPowerOutletTemplatesCreateRequest) GetPowerPort() BulkPowerOutletTemplateRequestPowerPort`

GetPowerPort returns the PowerPort field if non-nil, zero value otherwise.

### GetPowerPortOk

`func (o *DcimPowerOutletTemplatesCreateRequest) GetPowerPortOk() (*BulkPowerOutletTemplateRequestPowerPort, bool)`
...
`func (o *DcimPowerOutletTemplatesCreateRequest) SetPowerPort(v BulkPowerOutletTemplateRequestPowerPort)`
