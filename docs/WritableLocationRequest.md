...
`func NewWritableLocationRequest(name string, slug string, site BulkCoolingSourceRequestSite, ) *WritableLocationRequest`
...
`func (o *WritableLocationRequest) GetSite() BulkCoolingSourceRequestSite`

GetSite returns the Site field if non-nil, zero value otherwise.

### GetSiteOk

`func (o *WritableLocationRequest) GetSiteOk() (*BulkCoolingSourceRequestSite, bool)`
...
`func (o *WritableLocationRequest) SetSite(v BulkCoolingSourceRequestSite)`
