...
`func (o *IpamAsnsCreateRequest) GetRole() ASNRequestRole`

GetRole returns the Role field if non-nil, zero value otherwise.

### GetRoleOk

`func (o *IpamAsnsCreateRequest) GetRoleOk() (*ASNRequestRole, bool)`
...
`func (o *IpamAsnsCreateRequest) SetRole(v ASNRequestRole)`

SetRole sets Role field to given value.

### HasRole

`func (o *IpamAsnsCreateRequest) HasRole() bool`

HasRole returns a boolean if a field has been set.

### SetRoleNil

`func (o *IpamAsnsCreateRequest) SetRoleNil(b bool)`

 SetRoleNil sets the value for Role to be an explicit nil

### UnsetRole
`func (o *IpamAsnsCreateRequest) UnsetRole()`
