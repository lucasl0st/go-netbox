...
`func NewDcimFrontPortTemplatesCreateRequest(name string, type_ BulkFrontPortRequestType, ) *DcimFrontPortTemplatesCreateRequest`
...
`func (o *DcimFrontPortTemplatesCreateRequest) GetDeviceType() BulkConsolePortTemplateRequestDeviceType`

GetDeviceType returns the DeviceType field if non-nil, zero value otherwise.

### GetDeviceTypeOk

`func (o *DcimFrontPortTemplatesCreateRequest) GetDeviceTypeOk() (*BulkConsolePortTemplateRequestDeviceType, bool)`
...
`func (o *DcimFrontPortTemplatesCreateRequest) SetDeviceType(v BulkConsolePortTemplateRequestDeviceType)`
...
`func (o *DcimFrontPortTemplatesCreateRequest) GetModuleType() BulkConsolePortTemplateRequestModuleType`

GetModuleType returns the ModuleType field if non-nil, zero value otherwise.

### GetModuleTypeOk

`func (o *DcimFrontPortTemplatesCreateRequest) GetModuleTypeOk() (*BulkConsolePortTemplateRequestModuleType, bool)`
...
`func (o *DcimFrontPortTemplatesCreateRequest) SetModuleType(v BulkConsolePortTemplateRequestModuleType)`
...
`func (o *DcimFrontPortTemplatesCreateRequest) GetType() BulkFrontPortRequestType`

GetType returns the Type field if non-nil, zero value otherwise.

### GetTypeOk

`func (o *DcimFrontPortTemplatesCreateRequest) GetTypeOk() (*BulkFrontPortRequestType, bool)`
...
`func (o *DcimFrontPortTemplatesCreateRequest) SetType(v BulkFrontPortRequestType)`
...
`func (o *DcimFrontPortTemplatesCreateRequest) GetColor() BriefModuleBayTypeColor`

GetColor returns the Color field if non-nil, zero value otherwise.

### GetColorOk

`func (o *DcimFrontPortTemplatesCreateRequest) GetColorOk() (*BriefModuleBayTypeColor, bool)`
...
`func (o *DcimFrontPortTemplatesCreateRequest) SetColor(v BriefModuleBayTypeColor)`
