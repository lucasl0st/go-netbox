...
**IsBayCompatible** | **bool** |  | [readonly] 

## Methods

### NewModule

`func NewModule(id int32, url string, display string, device BriefDevice, moduleBay NestedModuleBay, moduleType BriefModuleType, isBayCompatible bool, ) *Module`
...
GetIsBayCompatible returns the IsBayCompatible field if non-nil, zero value otherwise.

### GetIsBayCompatibleOk

`func (o *Module) GetIsBayCompatibleOk() (*bool, bool)`

GetIsBayCompatibleOk returns a tuple with the IsBayCompatible field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.
...
SetIsBayCompatible sets IsBayCompatible field to given value.
