...
`func NewDcimDeviceBaysCreateRequest(device BriefCoolingIntakeRequestDevice, name string, ) *DcimDeviceBaysCreateRequest`
...
`func (o *DcimDeviceBaysCreateRequest) GetDevice() BriefCoolingIntakeRequestDevice`

GetDevice returns the Device field if non-nil, zero value otherwise.

### GetDeviceOk

`func (o *DcimDeviceBaysCreateRequest) GetDeviceOk() (*BriefCoolingIntakeRequestDevice, bool)`
...
`func (o *DcimDeviceBaysCreateRequest) SetDevice(v BriefCoolingIntakeRequestDevice)`
...
`func (o *DcimDeviceBaysCreateRequest) GetEnabled() bool`

GetEnabled returns the Enabled field if non-nil, zero value otherwise.

### GetEnabledOk

`func (o *DcimDeviceBaysCreateRequest) GetEnabledOk() (*bool, bool)`
...
`func (o *DcimDeviceBaysCreateRequest) SetEnabled(v bool)`

SetEnabled sets Enabled field to given value.

### HasEnabled

`func (o *DcimDeviceBaysCreateRequest) HasEnabled() bool`
...
`func (o *DcimDeviceBaysCreateRequest) GetInstalledDevice() BulkDeviceBayRequestInstalledDevice`

GetInstalledDevice returns the InstalledDevice field if non-nil, zero value otherwise.

### GetInstalledDeviceOk

`func (o *DcimDeviceBaysCreateRequest) GetInstalledDeviceOk() (*BulkDeviceBayRequestInstalledDevice, bool)`
...
`func (o *DcimDeviceBaysCreateRequest) SetInstalledDevice(v BulkDeviceBayRequestInstalledDevice)`
