...
`func NewDcimRackReservationsCreateRequest(rack BulkRackReservationRequestRack, units []int32, user BookmarkRequestUser, description string, ) *DcimRackReservationsCreateRequest`
...
`func (o *DcimRackReservationsCreateRequest) GetRack() BulkRackReservationRequestRack`

GetRack returns the Rack field if non-nil, zero value otherwise.

### GetRackOk

`func (o *DcimRackReservationsCreateRequest) GetRackOk() (*BulkRackReservationRequestRack, bool)`
...
`func (o *DcimRackReservationsCreateRequest) SetRack(v BulkRackReservationRequestRack)`
...
`func (o *DcimRackReservationsCreateRequest) GetStatus() BulkRackReservationRequestStatus`

GetStatus returns the Status field if non-nil, zero value otherwise.

### GetStatusOk

`func (o *DcimRackReservationsCreateRequest) GetStatusOk() (*BulkRackReservationRequestStatus, bool)`
...
`func (o *DcimRackReservationsCreateRequest) SetStatus(v BulkRackReservationRequestStatus)`
