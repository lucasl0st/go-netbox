...
`func (o *CircuitsCircuitTypesCreateRequest) GetColor() BriefModuleBayTypeColor`

GetColor returns the Color field if non-nil, zero value otherwise.

### GetColorOk

`func (o *CircuitsCircuitTypesCreateRequest) GetColorOk() (*BriefModuleBayTypeColor, bool)`
...
`func (o *CircuitsCircuitTypesCreateRequest) SetColor(v BriefModuleBayTypeColor)`
