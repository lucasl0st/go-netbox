...
`func NewVpnTunnelsCreateRequest(name string, encapsulation BulkTunnelRequestEncapsulation, ) *VpnTunnelsCreateRequest`
...
`func (o *VpnTunnelsCreateRequest) GetStatus() BulkTunnelRequestStatus`

GetStatus returns the Status field if non-nil, zero value otherwise.

### GetStatusOk

`func (o *VpnTunnelsCreateRequest) GetStatusOk() (*BulkTunnelRequestStatus, bool)`
...
`func (o *VpnTunnelsCreateRequest) SetStatus(v BulkTunnelRequestStatus)`
...
`func (o *VpnTunnelsCreateRequest) GetGroup() BulkTunnelRequestGroup`

GetGroup returns the Group field if non-nil, zero value otherwise.

### GetGroupOk

`func (o *VpnTunnelsCreateRequest) GetGroupOk() (*BulkTunnelRequestGroup, bool)`
...
`func (o *VpnTunnelsCreateRequest) SetGroup(v BulkTunnelRequestGroup)`
...
`func (o *VpnTunnelsCreateRequest) GetEncapsulation() BulkTunnelRequestEncapsulation`

GetEncapsulation returns the Encapsulation field if non-nil, zero value otherwise.

### GetEncapsulationOk

`func (o *VpnTunnelsCreateRequest) GetEncapsulationOk() (*BulkTunnelRequestEncapsulation, bool)`
...
`func (o *VpnTunnelsCreateRequest) SetEncapsulation(v BulkTunnelRequestEncapsulation)`
...
`func (o *VpnTunnelsCreateRequest) GetIpsecProfile() BulkTunnelRequestIpsecProfile`

GetIpsecProfile returns the IpsecProfile field if non-nil, zero value otherwise.

### GetIpsecProfileOk

`func (o *VpnTunnelsCreateRequest) GetIpsecProfileOk() (*BulkTunnelRequestIpsecProfile, bool)`
...
`func (o *VpnTunnelsCreateRequest) SetIpsecProfile(v BulkTunnelRequestIpsecProfile)`
