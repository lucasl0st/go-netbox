...
`func NewIpamServicesCreateRequest(parentObjectType string, parentObjectId int64, name string, ) *IpamServicesCreateRequest`
...
`func (o *IpamServicesCreateRequest) GetPortMappings() []string`

GetPortMappings returns the PortMappings field if non-nil, zero value otherwise.

### GetPortMappingsOk

`func (o *IpamServicesCreateRequest) GetPortMappingsOk() (*[]string, bool)`
...
`func (o *IpamServicesCreateRequest) SetPortMappings(v []string)`

SetPortMappings sets PortMappings field to given value.

### HasPortMappings

`func (o *IpamServicesCreateRequest) HasPortMappings() bool`

HasPortMappings returns a boolean if a field has been set.

### GetProtocol

`func (o *IpamServicesCreateRequest) GetProtocol() BulkServiceRequestProtocol`

GetProtocol returns the Protocol field if non-nil, zero value otherwise.

### GetProtocolOk

`func (o *IpamServicesCreateRequest) GetProtocolOk() (*BulkServiceRequestProtocol, bool)`
...
`func (o *IpamServicesCreateRequest) SetProtocol(v BulkServiceRequestProtocol)`

SetProtocol sets Protocol field to given value.

### HasProtocol

`func (o *IpamServicesCreateRequest) HasProtocol() bool`

HasProtocol returns a boolean if a field has been set.

### SetProtocolNil

`func (o *IpamServicesCreateRequest) SetProtocolNil(b bool)`

 SetProtocolNil sets the value for Protocol to be an explicit nil

### UnsetProtocol
`func (o *IpamServicesCreateRequest) UnsetProtocol()`
...
`func (o *IpamServicesCreateRequest) HasPorts() bool`

HasPorts returns a boolean if a field has been set.

### SetPortsNil

`func (o *IpamServicesCreateRequest) SetPortsNil(b bool)`

 SetPortsNil sets the value for Ports to be an explicit nil

### UnsetPorts
`func (o *IpamServicesCreateRequest) UnsetPorts()`
