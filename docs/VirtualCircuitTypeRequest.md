...
`func (o *VirtualCircuitTypeRequest) GetColor() BriefModuleBayTypeColor`

GetColor returns the Color field if non-nil, zero value otherwise.

### GetColorOk

`func (o *VirtualCircuitTypeRequest) GetColorOk() (*BriefModuleBayTypeColor, bool)`
...
`func (o *VirtualCircuitTypeRequest) SetColor(v BriefModuleBayTypeColor)`
