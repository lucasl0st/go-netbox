...
`func NewVpnTunnelTerminationsCreateRequest(tunnel BulkTunnelTerminationRequestTunnel, terminationType string, ) *VpnTunnelTerminationsCreateRequest`
...
`func (o *VpnTunnelTerminationsCreateRequest) GetTunnel() BulkTunnelTerminationRequestTunnel`

GetTunnel returns the Tunnel field if non-nil, zero value otherwise.

### GetTunnelOk

`func (o *VpnTunnelTerminationsCreateRequest) GetTunnelOk() (*BulkTunnelTerminationRequestTunnel, bool)`
...
`func (o *VpnTunnelTerminationsCreateRequest) SetTunnel(v BulkTunnelTerminationRequestTunnel)`
...
`func (o *VpnTunnelTerminationsCreateRequest) GetRole() BulkTunnelTerminationRequestRole`

GetRole returns the Role field if non-nil, zero value otherwise.

### GetRoleOk

`func (o *VpnTunnelTerminationsCreateRequest) GetRoleOk() (*BulkTunnelTerminationRequestRole, bool)`
...
`func (o *VpnTunnelTerminationsCreateRequest) SetRole(v BulkTunnelTerminationRequestRole)`
...
`func (o *VpnTunnelTerminationsCreateRequest) GetOutsideIp() BulkDeviceRequestPrimaryIp4`

GetOutsideIp returns the OutsideIp field if non-nil, zero value otherwise.

### GetOutsideIpOk

`func (o *VpnTunnelTerminationsCreateRequest) GetOutsideIpOk() (*BulkDeviceRequestPrimaryIp4, bool)`
...
`func (o *VpnTunnelTerminationsCreateRequest) SetOutsideIp(v BulkDeviceRequestPrimaryIp4)`
