...
`func (o *DcimModuleBayTemplatesCreateRequest) GetDeviceType() BulkConsolePortTemplateRequestDeviceType`

GetDeviceType returns the DeviceType field if non-nil, zero value otherwise.

### GetDeviceTypeOk

`func (o *DcimModuleBayTemplatesCreateRequest) GetDeviceTypeOk() (*BulkConsolePortTemplateRequestDeviceType, bool)`
...
`func (o *DcimModuleBayTemplatesCreateRequest) SetDeviceType(v BulkConsolePortTemplateRequestDeviceType)`
...
`func (o *DcimModuleBayTemplatesCreateRequest) GetModuleType() BulkConsolePortTemplateRequestModuleType`

GetModuleType returns the ModuleType field if non-nil, zero value otherwise.

### GetModuleTypeOk

`func (o *DcimModuleBayTemplatesCreateRequest) GetModuleTypeOk() (*BulkConsolePortTemplateRequestModuleType, bool)`
...
`func (o *DcimModuleBayTemplatesCreateRequest) SetModuleType(v BulkConsolePortTemplateRequestModuleType)`
...
`func (o *DcimModuleBayTemplatesCreateRequest) GetEnabled() bool`

GetEnabled returns the Enabled field if non-nil, zero value otherwise.

### GetEnabledOk

`func (o *DcimModuleBayTemplatesCreateRequest) GetEnabledOk() (*bool, bool)`
...
`func (o *DcimModuleBayTemplatesCreateRequest) SetEnabled(v bool)`

SetEnabled sets Enabled field to given value.

### HasEnabled

`func (o *DcimModuleBayTemplatesCreateRequest) HasEnabled() bool`
...
`func (o *DcimModuleBayTemplatesCreateRequest) GetModuleBayTypes() []int32`

GetModuleBayTypes returns the ModuleBayTypes field if non-nil, zero value otherwise.

### GetModuleBayTypesOk

`func (o *DcimModuleBayTemplatesCreateRequest) GetModuleBayTypesOk() (*[]int32, bool)`
...
`func (o *DcimModuleBayTemplatesCreateRequest) SetModuleBayTypes(v []int32)`

SetModuleBayTypes sets ModuleBayTypes field to given value.

### HasModuleBayTypes

`func (o *DcimModuleBayTemplatesCreateRequest) HasModuleBayTypes() bool`
