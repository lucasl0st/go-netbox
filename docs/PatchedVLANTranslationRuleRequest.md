...
`func (o *PatchedVLANTranslationRuleRequest) GetTags() []NestedTagRequest`

GetTags returns the Tags field if non-nil, zero value otherwise.

### GetTagsOk

`func (o *PatchedVLANTranslationRuleRequest) GetTagsOk() (*[]NestedTagRequest, bool)`
...
`func (o *PatchedVLANTranslationRuleRequest) SetTags(v []NestedTagRequest)`

SetTags sets Tags field to given value.

### HasTags

`func (o *PatchedVLANTranslationRuleRequest) HasTags() bool`

HasTags returns a boolean if a field has been set.

### GetCustomFields

`func (o *PatchedVLANTranslationRuleRequest) GetCustomFields() map[string]interface{}`

GetCustomFields returns the CustomFields field if non-nil, zero value otherwise.

### GetCustomFieldsOk

`func (o *PatchedVLANTranslationRuleRequest) GetCustomFieldsOk() (*map[string]interface{}, bool)`
...
`func (o *PatchedVLANTranslationRuleRequest) SetCustomFields(v map[string]interface{})`

SetCustomFields sets CustomFields field to given value.

### HasCustomFields

`func (o *PatchedVLANTranslationRuleRequest) HasCustomFields() bool`
