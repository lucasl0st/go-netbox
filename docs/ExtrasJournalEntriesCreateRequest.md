...
`func (o *ExtrasJournalEntriesCreateRequest) GetKind() BulkJournalEntryRequestKind`

GetKind returns the Kind field if non-nil, zero value otherwise.

### GetKindOk

`func (o *ExtrasJournalEntriesCreateRequest) GetKindOk() (*BulkJournalEntryRequestKind, bool)`
...
`func (o *ExtrasJournalEntriesCreateRequest) SetKind(v BulkJournalEntryRequestKind)`
