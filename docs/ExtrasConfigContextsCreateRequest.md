...
`func (o *ExtrasConfigContextsCreateRequest) GetProfile() BulkConfigContextRequestProfile`

GetProfile returns the Profile field if non-nil, zero value otherwise.

### GetProfileOk

`func (o *ExtrasConfigContextsCreateRequest) GetProfileOk() (*BulkConfigContextRequestProfile, bool)`
...
`func (o *ExtrasConfigContextsCreateRequest) SetProfile(v BulkConfigContextRequestProfile)`
...
`func (o *ExtrasConfigContextsCreateRequest) GetDataSource() BulkConfigContextProfileRequestDataSource`

GetDataSource returns the DataSource field if non-nil, zero value otherwise.

### GetDataSourceOk

`func (o *ExtrasConfigContextsCreateRequest) GetDataSourceOk() (*BulkConfigContextProfileRequestDataSource, bool)`
...
`func (o *ExtrasConfigContextsCreateRequest) SetDataSource(v BulkConfigContextProfileRequestDataSource)`
