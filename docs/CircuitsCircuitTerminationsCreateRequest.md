...
`func NewCircuitsCircuitTerminationsCreateRequest(circuit BulkCircuitTerminationRequestCircuit, termSide TerminationSide1, ) *CircuitsCircuitTerminationsCreateRequest`
...
`func (o *CircuitsCircuitTerminationsCreateRequest) GetCircuit() BulkCircuitTerminationRequestCircuit`

GetCircuit returns the Circuit field if non-nil, zero value otherwise.

### GetCircuitOk

`func (o *CircuitsCircuitTerminationsCreateRequest) GetCircuitOk() (*BulkCircuitTerminationRequestCircuit, bool)`
...
`func (o *CircuitsCircuitTerminationsCreateRequest) SetCircuit(v BulkCircuitTerminationRequestCircuit)`
