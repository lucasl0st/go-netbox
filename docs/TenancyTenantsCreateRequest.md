...
`func (o *TenancyTenantsCreateRequest) GetGroup() BulkTenantRequestGroup`

GetGroup returns the Group field if non-nil, zero value otherwise.

### GetGroupOk

`func (o *TenancyTenantsCreateRequest) GetGroupOk() (*BulkTenantRequestGroup, bool)`
...
`func (o *TenancyTenantsCreateRequest) SetGroup(v BulkTenantRequestGroup)`
