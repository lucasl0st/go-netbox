...
`func (o *RearPortTemplateRequest) GetColor() BriefModuleBayTypeColor`

GetColor returns the Color field if non-nil, zero value otherwise.

### GetColorOk

`func (o *RearPortTemplateRequest) GetColorOk() (*BriefModuleBayTypeColor, bool)`
...
`func (o *RearPortTemplateRequest) SetColor(v BriefModuleBayTypeColor)`
