...
`func NewTenancyContactAssignmentsCreateRequest(objectType string, objectId int64, contact BulkContactAssignmentRequestContact, ) *TenancyContactAssignmentsCreateRequest`
...
`func (o *TenancyContactAssignmentsCreateRequest) GetContact() BulkContactAssignmentRequestContact`

GetContact returns the Contact field if non-nil, zero value otherwise.

### GetContactOk

`func (o *TenancyContactAssignmentsCreateRequest) GetContactOk() (*BulkContactAssignmentRequestContact, bool)`
...
`func (o *TenancyContactAssignmentsCreateRequest) SetContact(v BulkContactAssignmentRequestContact)`
...
`func (o *TenancyContactAssignmentsCreateRequest) GetRole() BulkContactAssignmentRequestRole`

GetRole returns the Role field if non-nil, zero value otherwise.

### GetRoleOk

`func (o *TenancyContactAssignmentsCreateRequest) GetRoleOk() (*BulkContactAssignmentRequestRole, bool)`
...
`func (o *TenancyContactAssignmentsCreateRequest) SetRole(v BulkContactAssignmentRequestRole)`
