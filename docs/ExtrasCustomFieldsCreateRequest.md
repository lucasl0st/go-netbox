...
`func (o *ExtrasCustomFieldsCreateRequest) GetNullsFirst() bool`

GetNullsFirst returns the NullsFirst field if non-nil, zero value otherwise.

### GetNullsFirstOk

`func (o *ExtrasCustomFieldsCreateRequest) GetNullsFirstOk() (*bool, bool)`
...
`func (o *ExtrasCustomFieldsCreateRequest) SetNullsFirst(v bool)`

SetNullsFirst sets NullsFirst field to given value.

### HasNullsFirst

`func (o *ExtrasCustomFieldsCreateRequest) HasNullsFirst() bool`
...
`func (o *ExtrasCustomFieldsCreateRequest) GetValidationSchema() interface{}`

GetValidationSchema returns the ValidationSchema field if non-nil, zero value otherwise.

### GetValidationSchemaOk

`func (o *ExtrasCustomFieldsCreateRequest) GetValidationSchemaOk() (*interface{}, bool)`
...
`func (o *ExtrasCustomFieldsCreateRequest) SetValidationSchema(v interface{})`

SetValidationSchema sets ValidationSchema field to given value.

### HasValidationSchema

`func (o *ExtrasCustomFieldsCreateRequest) HasValidationSchema() bool`

HasValidationSchema returns a boolean if a field has been set.

### SetValidationSchemaNil

`func (o *ExtrasCustomFieldsCreateRequest) SetValidationSchemaNil(b bool)`

 SetValidationSchemaNil sets the value for ValidationSchema to be an explicit nil

### UnsetValidationSchema
`func (o *ExtrasCustomFieldsCreateRequest) UnsetValidationSchema()`

UnsetValidationSchema ensures that no value is present for ValidationSchema, not even an explicit nil
### GetChoiceSet

`func (o *ExtrasCustomFieldsCreateRequest) GetChoiceSet() BulkCustomFieldRequestChoiceSet`

GetChoiceSet returns the ChoiceSet field if non-nil, zero value otherwise.

### GetChoiceSetOk

`func (o *ExtrasCustomFieldsCreateRequest) GetChoiceSetOk() (*BulkCustomFieldRequestChoiceSet, bool)`
...
`func (o *ExtrasCustomFieldsCreateRequest) SetChoiceSet(v BulkCustomFieldRequestChoiceSet)`
