...
`func NewWritableInventoryItemRequest(device BriefCoolingIntakeRequestDevice, name string, ) *WritableInventoryItemRequest`
...
`func (o *WritableInventoryItemRequest) GetDevice() BriefCoolingIntakeRequestDevice`

GetDevice returns the Device field if non-nil, zero value otherwise.

### GetDeviceOk

`func (o *WritableInventoryItemRequest) GetDeviceOk() (*BriefCoolingIntakeRequestDevice, bool)`
...
`func (o *WritableInventoryItemRequest) SetDevice(v BriefCoolingIntakeRequestDevice)`
