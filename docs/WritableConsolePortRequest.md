...
`func NewWritableConsolePortRequest(device BriefCoolingIntakeRequestDevice, name string, ) *WritableConsolePortRequest`
...
`func (o *WritableConsolePortRequest) GetDevice() BriefCoolingIntakeRequestDevice`

GetDevice returns the Device field if non-nil, zero value otherwise.

### GetDeviceOk

`func (o *WritableConsolePortRequest) GetDeviceOk() (*BriefCoolingIntakeRequestDevice, bool)`
...
`func (o *WritableConsolePortRequest) SetDevice(v BriefCoolingIntakeRequestDevice)`
