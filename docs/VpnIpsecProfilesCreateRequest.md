...
`func NewVpnIpsecProfilesCreateRequest(name string, mode BulkIPSecProfileRequestMode, ikePolicy BulkIPSecProfileRequestIkePolicy, ipsecPolicy BulkIPSecProfileRequestIpsecPolicy, ) *VpnIpsecProfilesCreateRequest`
...
`func (o *VpnIpsecProfilesCreateRequest) GetMode() BulkIPSecProfileRequestMode`

GetMode returns the Mode field if non-nil, zero value otherwise.

### GetModeOk

`func (o *VpnIpsecProfilesCreateRequest) GetModeOk() (*BulkIPSecProfileRequestMode, bool)`
...
`func (o *VpnIpsecProfilesCreateRequest) SetMode(v BulkIPSecProfileRequestMode)`
...
`func (o *VpnIpsecProfilesCreateRequest) GetIkePolicy() BulkIPSecProfileRequestIkePolicy`

GetIkePolicy returns the IkePolicy field if non-nil, zero value otherwise.

### GetIkePolicyOk

`func (o *VpnIpsecProfilesCreateRequest) GetIkePolicyOk() (*BulkIPSecProfileRequestIkePolicy, bool)`
...
`func (o *VpnIpsecProfilesCreateRequest) SetIkePolicy(v BulkIPSecProfileRequestIkePolicy)`
...
`func (o *VpnIpsecProfilesCreateRequest) GetIpsecPolicy() BulkIPSecProfileRequestIpsecPolicy`

GetIpsecPolicy returns the IpsecPolicy field if non-nil, zero value otherwise.

### GetIpsecPolicyOk

`func (o *VpnIpsecProfilesCreateRequest) GetIpsecPolicyOk() (*BulkIPSecProfileRequestIpsecPolicy, bool)`
...
`func (o *VpnIpsecProfilesCreateRequest) SetIpsecPolicy(v BulkIPSecProfileRequestIpsecPolicy)`
