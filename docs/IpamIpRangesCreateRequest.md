...
`func (o *IpamIpRangesCreateRequest) GetVrf() BulkIPAddressRequestVrf`

GetVrf returns the Vrf field if non-nil, zero value otherwise.

### GetVrfOk

`func (o *IpamIpRangesCreateRequest) GetVrfOk() (*BulkIPAddressRequestVrf, bool)`
...
`func (o *IpamIpRangesCreateRequest) SetVrf(v BulkIPAddressRequestVrf)`
...
`func (o *IpamIpRangesCreateRequest) GetRole() ASNRequestRole`

GetRole returns the Role field if non-nil, zero value otherwise.

### GetRoleOk

`func (o *IpamIpRangesCreateRequest) GetRoleOk() (*ASNRequestRole, bool)`
...
`func (o *IpamIpRangesCreateRequest) SetRole(v ASNRequestRole)`
