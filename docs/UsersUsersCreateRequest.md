...
`func (o *UsersUsersCreateRequest) GetEmail() EmailAddress`

GetEmail returns the Email field if non-nil, zero value otherwise.

### GetEmailOk

`func (o *UsersUsersCreateRequest) GetEmailOk() (*EmailAddress, bool)`
...
`func (o *UsersUsersCreateRequest) SetEmail(v EmailAddress)`
