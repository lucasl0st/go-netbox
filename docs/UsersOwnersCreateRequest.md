...
`func (o *UsersOwnersCreateRequest) GetGroup() BulkOwnerRequestGroup`

GetGroup returns the Group field if non-nil, zero value otherwise.

### GetGroupOk

`func (o *UsersOwnersCreateRequest) GetGroupOk() (*BulkOwnerRequestGroup, bool)`
...
`func (o *UsersOwnersCreateRequest) SetGroup(v BulkOwnerRequestGroup)`
