...
`func (o *ExtrasCustomLinksCreateRequest) GetButtonClass() BulkCustomLinkRequestButtonClass`

GetButtonClass returns the ButtonClass field if non-nil, zero value otherwise.

### GetButtonClassOk

`func (o *ExtrasCustomLinksCreateRequest) GetButtonClassOk() (*BulkCustomLinkRequestButtonClass, bool)`
...
`func (o *ExtrasCustomLinksCreateRequest) SetButtonClass(v BulkCustomLinkRequestButtonClass)`
