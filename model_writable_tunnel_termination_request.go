...
type WritableTunnelTerminationRequest struct {
	...
	OutsideIp            NullableBulkDeviceRequestPrimaryIp4 `json:"outside_ip,omitempty"`
...
// SetOutsideIp gets a reference to the given NullableBulkDeviceRequestPrimaryIp4 and assigns it to the OutsideIp field.
