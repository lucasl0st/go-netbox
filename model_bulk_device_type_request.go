...
type BulkDeviceTypeRequest struct {
	...
	DefaultPlatform NullableBulkDeviceRequestPlatform  `json:"default_platform,omitempty"`
...
// SetDefaultPlatform gets a reference to the given NullableBulkDeviceRequestPlatform and assigns it to the DefaultPlatform field.
