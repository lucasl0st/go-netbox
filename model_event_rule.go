...
type EventRule struct {
	...
	ActionIsAvailable    bool                   `json:"action_is_available"`
...
func NewEventRule(id int32, url string, display string, objectTypes []string, name string, eventTypes []BulkEventRuleRequestEventTypesInner, actionType EventRuleActionType, actionIsAvailable bool) *EventRule {
	...
	this.ActionIsAvailable = actionIsAvailable
	return &this
}
...
// GetActionIsAvailable returns the ActionIsAvailable field value
...
// GetActionIsAvailableOk returns a tuple with the ActionIsAvailable field value
// and a boolean to check if the value has been set.
...
// SetActionIsAvailable sets field value
